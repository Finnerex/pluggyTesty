        ...
        BukkitRunnable runnable = new BukkitRunnable() {
            ...
            public void run() {
                ...
                for (float i = 0; i < 5.8; i += 0.2) {
                    world.spawnParticle(Particle.TOTEM_OF_UNDYING, drawLocation, 1, 0.2, 0, 0, 0);
                    world.spawnParticle(Particle.TOTEM_OF_UNDYING, drawLocation.clone().add(0, 0, 6), 2, 0.2, 0, 0, 0);
                    drawLocation.add(0.2, 0, 0);
                }
                for (float i = 0; i < 5.8; i += 0.2) {
                    world.spawnParticle(Particle.TOTEM_OF_UNDYING, drawLocation, 1, 0, 0, 0.2, 0);
                    world.spawnParticle(Particle.TOTEM_OF_UNDYING, drawLocation.clone().add(-6, 0, 0), 2, 0, 0, 0.2, 0);
