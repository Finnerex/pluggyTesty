...
public class TradeSilo {
    ...
    public final static HashMap<Villager.Profession, int[]> tradeAmts = (HashMap<Villager.Profession, int[]>) Map.ofEntries(
            ...
            Map.entry(Villager.Profession.CLERIC, new int[] {3, 2, 1, 1, 3}), // Cleric
            Map.entry(Villager.Profession.FARMER, new int[] {2, 2, 1, 1, 1}), // Farmer
            Map.entry(Villager.Profession.FISHERMAN, new int[] {2, 1, 1, 1, 1}), // Fisherman
            Map.entry(Villager.Profession.FLETCHER, new int[] {0, 0, 0, 0, 0}), // Fletcher
            Map.entry(Villager.Profession.LEATHERWORKER, new int[] {0, 0, 0, 0, 0}), // Leatherworker
            Map.entry(Villager.Profession.LIBRARIAN, new int[] {2, 2, 2, 2, 2}), // Librarian
            Map.entry(Villager.Profession.MASON, new int[] {2, 2, 2, 1, 2}), // Mason
            Map.entry(Villager.Profession.SHEPHERD, new int[] {0, 0, 0, 0, 0}), // Shepherd
            Map.entry(Villager.Profession.TOOLSMITH, new int[] {2, 2, 2, 2, 2}), // Toolsmith
            Map.entry(Villager.Profession.WEAPONSMITH, new int[] {1, 1, 1, 1, 1}) // Weaponsmith
    );
